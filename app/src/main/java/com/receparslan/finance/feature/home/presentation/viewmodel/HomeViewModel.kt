package com.receparslan.finance.feature.home.presentation.viewmodel

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.receparslan.finance.core.common.Resource
import com.receparslan.finance.feature.home.domain.usecase.GetCryptoListUseCase
import com.receparslan.finance.feature.home.presentation.state.HomeUIState
...
class HomeViewModel @Inject constructor(
    ...
    private fun initCryptocurrenciesByPage(page: Int) = viewModelScope.launch {
        try {
            when (val resource = getCryptoListUseCase(page)) {
                is Resource.Success ->
                    _uiState.update { currentState ->
                        currentState.copy(
                            isLoading = false,
