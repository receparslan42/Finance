package com.receparslan.finance.feature.favourites.presentation.viewmodel

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.receparslan.finance.core.common.Resource
import com.receparslan.finance.feature.favourites.domain.usecase.ObserveFavoritesUseCase
import com.receparslan.finance.feature.favourites.presentation.state.FavouriteUIState
...
@Inject constructor(
    ...
    init {
        ...
        viewModelScope.launch {
            when (val resource = observeFavoritesUseCase().first()) {
                is Resource.Success ->
                    _uiState.update { currentState ->
                        currentState.copy(
                            isLoading = false,
