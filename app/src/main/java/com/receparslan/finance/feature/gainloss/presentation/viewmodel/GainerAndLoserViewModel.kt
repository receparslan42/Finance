package com.receparslan.finance.feature.gainloss.presentation.viewmodel

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.receparslan.finance.core.common.Resource
import com.receparslan.finance.feature.gainloss.domain.usecase.GetGainersAndLosersUseCase
import com.receparslan.finance.feature.gainloss.presentation.state.GainerAndLoserUIState
...
class GainerAndLoserViewModel @Inject constructor(
    private val getGainersAndLosersUseCase: GetGainersAndLosersUseCase
) : ViewModel() {
    ...
    private fun initGainersAndLosersList() = viewModelScope.launch {
        when (val resource = getGainersAndLosersUseCase()) {
            is Resource.Success ->
                _uiState.update { currentState ->
                    currentState.copy(
                        isLoading = false,
