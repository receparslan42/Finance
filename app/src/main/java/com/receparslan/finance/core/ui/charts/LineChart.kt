package com.receparslan.finance.core.ui.charts
...
import com.receparslan.finance.core.ui.markers.rememberMarker
import com.receparslan.finance.core.common.Constants.ExtraKeys
...
val MarkerValueFormatter = object : DefaultCartesianMarker.ValueFormatter {
    override fun format(
        ...
        val color = if (prevItem.close.toDouble() < item.close.toDouble()) Color.Green
        else if (prevItem.close.toDouble() > item.close.toDouble()) Color.Red
        else Color.White
